  ...
  return (
    <div className="max-w-xl mx-auto space-y-4 text-center px-2">
      ...
      <div className="grid grid-cols-1 gap-3 pt-2">
        ...
        >
          <div>
            <h3 className="text-sm font-bold text-white mb-1">{txt.modoClasicoTitulo}</h3>
            <p className="text-xs text-slate-400">{txt.modoClasicoDesc}</p>
          </div>
        ...
        >
          <div>
            <h3 className="text-sm font-bold text-white mb-1">{txt.modoJuicioTitulo}</h3>
            <p className="text-xs text-slate-400">{txt.modoJuicioDesc}</p>
          </div>
